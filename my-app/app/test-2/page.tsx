...
export default function TaskPage(){
    return(
        ...
        <div className="bg-blue-400 p-8 h-72 w-122 rounded-4xl flex flex-col justify-between text-blue-950 relative transition-all duration-300 hover:-translate-y-4 hover:shadow-xl hover:bg-black hover:text-white cursor-pointer">
...
<div>
    ...
    <div className="flex -space-x-3 items-center">
         ...
         <div className="bg-green-400 p-8 h-72 w-122 rounded-4xl flex flex-col justify-between text-blue-950 relative transition-all duration-300 hover:-translate-y-4 hover:shadow-xl hover:bg-black hover:text-white cursor-pointer">
...
<div>
 ...
 <div className="absolute bottom-8 right-8">
    <div className="flex -space-x-3 items-center">
        ...
        <div className="bg-purple-400 p-8 h-72 w-80 rounded-4xl flex flex-col justify-between text-blue-950 transition-all duration-300 hover:-translate-y-4 hover:shadow-xl hover:bg-black hover:text-white cursor-pointer">
            <div className="flex gap-3">
                <img src="palette.svg" alt="palette" />
                <p className="font-bold">Design</p>
            </div>
<div>
    ...
    <p className="font-bold">8 Hours ago</p>
         ...
         <div className="bg-orange-400 p-8 h-72 w-80 rounded-4xl flex flex-col justify-between text-blue-950 transition-all duration-300 hover:-translate-y-4 hover:shadow-xl hover:bg-black hover:text-white cursor-pointer">
            <div className="flex gap-3">
...
<div>
    ...
    <p className="font-bold">2 Days ago</p>
        ...
        <div className="bg-red-400 p-8 h-72 w-80 rounded-4xl flex flex-col justify-between text-blue-950 transition-all duration-300 hover:-translate-y-4 hover:shadow-xl hover:bg-black hover:text-white cursor-pointer">
            <div className="flex gap-3">
                <img src="palette.svg" alt="palette" />
                <p className="font-bold">Design</p>
            </div>
